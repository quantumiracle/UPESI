...
class AcrobotEnv(core.Env):
    ...
    **REFERENCE:**
    ...
    def reset_props(self,
                    LINK_LENGTH_1 = 1., LINK_LENGTH_2 = 1.,
                    LINK_MASS_1 = 1., LINK_MASS_2 = 1.,
                    LINK_COM_POS_REL_1 = 0.5, LINK_COM_POS_REL_2 = 0.5,
                    LINK_MOI = 1.,
                    **kwargs):
        ...
        self.LINK_COM_POS_1 = LINK_COM_POS_REL_1 * LINK_LENGTH_1  #: [m] position of the center of mass of link 1
        self.LINK_COM_POS_2 = LINK_COM_POS_REL_2 * LINK_LENGTH_2  #: [m] position of the center of mass of link 2
    ...
    def step(self, a):
        ...
        reward = None
        # if -cos(s[0]) - cos(s[1] + s[0]) > 1:
        #     reward = 0
        # elif -cos(s[0]) - cos(s[1] + s[0]) > 1:
        #     reward = -0.8
        # else:
        #     reward = -1
        reward = -1. if not terminal else 0.
        # reward = (-cos(s[0]) - cos(s[1] + s[0]))-1
    ...
    parameters_spec = {
        'LINK_LENGTH_1': [0.1, 0.9],
        'LINK_LENGTH_2': [0.1, 0.9],
        'LINK_MASS_1': [0.1, 0.9],
        'LINK_MASS_2': [0.1, 0.9],
        'LINK_COM_POS_REL_1': [0., 1.],
        'LINK_COM_POS_REL_2': [0., 1.]
        # 'LINK_MOI': default is 1
    }

    ref_high = np.array([1.0, 1.0, 1.0, 1.0, pi, pi], dtype=np.float32)
    ref_observation_space = spaces.Box(-ref_high, ref_high)
    ref_action_space = spaces.Discrete(3)
