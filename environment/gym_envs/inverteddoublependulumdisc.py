...
# TODO add parameters manipulation
# discretize action to -1, 0, 1
...
class InvertedDoublePendulumDiscreteEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    name = 'inverteddoublependulumdisc'
